...
const Header = () => {
  ...
  return (
    <div className="absolute md:px-2 md:py-2 p-2 md:pt-3 z-10 flex items-center justify-between  w-full bg-gradient-to-b from-black from-30% ">
      <Link
        to="/"
        onClick={() => {
      ...
      >
        <img
          className="md:w-60 w-[50vw] max-w-50 mx-auto md:mx-0 cursor-pointer"
          src={logo}
          alt="logo"
        />
      </Link>
